  ...
  <div class="card-body">
    ...
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <?php
         ...
         $ambil_data = mysqli_query($conn, 'SELECT * FROM tb_barang');
         while ($tampil = mysqli_fetch_array($ambil_data)){
          ...
          <tr>
              ...
              <td>$tampil[mac]</td>
              <td>$tampil[status_barang_mounting]</td>
              <td>
                    <a href='edit-barang-ready.php?kode=$tampil[id]'>
    ...
    if(isset($_GET['hapus'])){
        ...
        mysqli_query($conn, "DELETE FROM tb_barang WHERE id='$_GET[hapus]'")
        or die (mysqli_error($conn));

        echo "<meta http-equiv=refresh content=0;URL='barang-ready.php'>";
    }
    ?>
